    ...
    <div class="col-xl-12">
        ...
        <div class="row">
            ...
            <div class="col-xl-12" id='form-input' style='display:none'>
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Form Input Master RW</h4>
                            ...
                            <div class="row">
                                <div class="row col-12">
                                    <div class="row">
                                        ...
                                        <div class="row col-12">
                                            <h4 class="card-title">Daftar RW</h4>
                                            <p class="card-title-desc">Pastikan inputan RW anda belum ada di sistem atau daftar ini.
                                            <table id="grid_2"class="display responsive" width="100%" style='font-size:11px;'>
                                                <thead>
                                                    <tr>
                                                        <th><b>id.</b></th>
                                                        <th><b>No.</b></th>
...
<script>
    function load_kecamatan(){
        $('#kec-id').select2({
            ...
            ajax: {
                url: '{{ url("master-rw/data-kecamatan") }}', // URL ke route
                dataType: 'json',
                delay: 250, 
    ...
    $(document).ready(function() {
        ...
        $("#kec-id").on("change",function(e){
            ...
            $('#kel-id').select2({
                placeholder: 'Pilih Kelurahan', // Placeholder
                ajax: {
                    url: '{{ url("master-rw/data-kelurahan") }}', // URL ke route
                    dataType: 'json',
                    // delay: 250,
                    data: function (params) {
                        return {
        ...
        $("#kel-id").on("change",function(e){
            e.preventDefault();
            table.ajax.url("{{ url('master-rw/daftar-rw') }}?" + $.param({
                kel_id: this.value
            })).load();

            // Memuat ulang data dengan data tambahan
        ...
        $(".save").on("click",function(e){
            ...
            $.ajax({
                url: "{{ url('master-rw/save-data') }}", // URL tujuan
                method: 'POST',
                data: {
                    id,kel_id,kode,nama
                },
